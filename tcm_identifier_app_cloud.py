...
class UltimateGardeniaIdentifier:
    ...
    def __init__(self, database_path, ms_positive_path, ms_negative_path,
                 ...
                 external_diagnostic_files=None,   # 列表，支持多个文件
...
def show_home_page():
    ...
    with col2:
        ...
        <div class="feature-card">
            <h4>⚡ 综合评分系统</h4>
            <p>基础分 + ppm调整 + 碎片加分 + 诊断离子加分 + 中性丢失 + RT得分 + 多加和离子融合，总分≤100。</p>
        </div>
        <div class="feature-card">
            <h4>🌱 药材来源合并</h4>
            ...
            with st.spinner("正在初始化鉴定程序..."):
                try:
                    ...
                    identifier = UltimateGardeniaIdentifier(
                        ...
                        rt_tolerance=rt_tolerance,
                        loss_tolerance=loss_tolerance,
                        external_diagnostic_files=diag_paths,
...
def show_guide_page():
    ...
    - 辅助诊断离子库：文件名为“辅助诊断离子库.xlsx”，应包含“化合物类型”、“离子m/z”列，以及可选的“诊断离子类别”列（值为“辅助诊断离子”），若无此列则根据文件名自动分配权重1。
    """)
